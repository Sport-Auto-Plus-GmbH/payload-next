...
export interface Tenant {
  ...
  name: string;
  /**
   * Used to resolve the tenant when a request has no matching domain.
   */
  slug: string;
  /**
   * Public domain this tenant is served under, e.g. sportautoplus.de
   */
  domain?: string | null;
  /**
...
export interface User {
  id: number;
  /**
   * Global system role. Super Admin bypasses all tenant scoping (see isSuperAdmin). Per-tenant roles (tenant-admin / tenant-viewer) are set per row in the "Tenants" field below, added automatically by the multi-tenant plugin.
   */
